 ...
 */
import type { GetKeywordNaturesById200KeywordsItemMatchingType } from './getKeywordNaturesById200KeywordsItemMatchingType';
...
import type { GetKeywordNaturesById200KeywordsItemCreatedById } from './getKeywordNaturesById200KeywordsItemCreatedById';
...
export type GetKeywordNaturesById200KeywordsItem = {
  ...
  name: string;
  description: string;
  matchingType: GetKeywordNaturesById200KeywordsItemMatchingType;
  categoryId: string;
  natureId: string;
  imageId: GetKeywordNaturesById200KeywordsItemImageId;
  parentId: GetKeywordNaturesById200KeywordsItemParentId;
  novelId: string;
  createdById: GetKeywordNaturesById200KeywordsItemCreatedById;
